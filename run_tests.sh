...
export CFG_MQTT_TLS_CA_CERTS=${PWD}/tests/integration/mosquitto/ca/ca.crt
export CFG_MQTT_TLS_CERTFILE=${PWD}/tests/integration/mosquitto/client/client.crt
export CFG_MQTT_TLS_KEYFILE=${PWD}/tests/integration/mosquitto/client/client.key
