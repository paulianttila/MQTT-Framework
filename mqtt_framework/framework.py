...
class Framework:
    ...
    def _do_healthy_check(self) -> tuple[str, int]:
    ...
    def _printjobs(self) -> tuple[str, int]:
        jobs = [
            {
                "id": str(job.id),
                "name": str(job.name),
